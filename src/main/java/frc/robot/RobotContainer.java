...
public class RobotContainer {
  ...
  */
  ...
  private void configureButtonBindings() {
    ...
    staticLock.whenPressed(new LogCommandWrapper(new OpenStaticHooks(climberWinchSubsystem)));
    staticUnlock.whenPressed(new LogCommandWrapper(new CloseStaticHooks(climberWinchSubsystem)));
