...
public class MoveClimberToNextBar extends SequentialCommandGroup {
  ...
  public MoveClimberToNextBar(ClimberArmSubsystem climberArmSubsystem, ClimberWinchSubsystem climberWinchSubsystem, TurretSubsystem turretSubsystem, LimeLightVision vision, XboxController climberController) {
