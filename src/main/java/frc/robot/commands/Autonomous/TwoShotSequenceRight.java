...
public class TwoShotSequenceRight extends SequentialCommandGroup {
  ...
  public TwoShotSequenceRight(TurretSubsystem turretSubsystem, double turretSpeed, IntakeSubsystem intakeSubsystem, DriveTrain driveTrain, double speed, double distanceInches, ShooterSubsystem shooterSubsystem) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new AutoSetShootingPosition(turretSubsystem, turretSpeed, Constants.AUTO_RIGHT_TURRET_ANGLE),
